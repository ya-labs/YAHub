...
3. [Visão geral](planejamento-inicial/visao-geral.md)
4. [Roadmap inicial](planejamento-inicial/roadmap.md)
5. Documento técnico ou de planejamento relacionado à tarefa.
...
Use o YABook quando a dúvida for sobre padrão reutilizável da YA LABS:
