...
- **YA Hub:** portal oficial e portfólio institucional da organização.
...
- O YA Hub deve ser específico do produto, sem duplicar padrões gerais do Handbook.
...
O Handbook da YA LABS é a fonte oficial para padrões organizacionais, como fluxo de trabalho, issues, branches, commits, Pull Requests, uso de IA e boas práticas de documentação.
